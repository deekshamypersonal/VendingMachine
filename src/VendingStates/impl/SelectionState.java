...
public class SelectionState implements State {
    ...
    public void insertCoin(VendingMachine machine, Coin coin) throws Exception{
        throw new Exception("you can not insert VendingMachine.VendingMachine.Coin in selection state");
    }
    ...
    public int getChange(int returnExtraMoney) throws Exception{
        ...
        System.out.println("Returned the change in the VendingMachine.VendingMachine.Coin Dispense Tray: " + returnExtraMoney);
        return returnExtraMoney;
    }

    @Override
    public List<Coin> refundFullMoney(VendingMachine machine) throws Exception{
        System.out.println("Returned the full amount back in the VendingMachine.VendingMachine.Coin Dispense Tray");
    ...
    public void updateInventory(VendingMachine machine, Item item, int codeNumber) throws Exception {
        throw new Exception("VendingMachine.VendingMachine.Inventory can not be updated in Selection state");
    }
